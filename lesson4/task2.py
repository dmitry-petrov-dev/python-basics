# 2: Дана дата в формате dd.mm.yyyy, например: 02.11.2013. Ваша задача — вывести дату в текстовом виде, например: второе
# ноября 2013 года. Склонением пренебречь (2000 года, 2010 года)

date_in = "02.11.2013"
days_dict = {"01": 'первое', "02": 'второе', "03": 'третье', "04": 'четвертое', "05": 'пятое', "06": 'шестое',
...
date_tmp = date_in.split(".")
print(days_dict[date_tmp[0]] + " " + month_dict[date_tmp[1]] + " " + date_tmp[2] + " года")
